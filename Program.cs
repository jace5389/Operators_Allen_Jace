// See https://aka.ms/new-console-template for more information
{
  ...
  Console.WriteLine($"{shortMult} is greater than {shortAdd}, {isshortGreater}.\n");
    ...
    Console.WriteLine($"The max of {floatMult} and {floatAdd} is {Math.Min(floatMult, floatAdd)}. " +
    ...
    // Prfloats if floatMult is greater than floatAdd
    ...
    // Prdoubles the maximum and minimum of the two double variables 
    Console.WriteLine($"The max of {doubleMult} and {doubleAdd} is {Math.Min(doubleMult, doubleAdd)}. " +
